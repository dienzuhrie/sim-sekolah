          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Muhammad Saifuddin Zuhri</h3>

                <p class="text-muted text-center">sukafisika@gmail.com<br>121328386287361</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Kelas</b> <a class="float-right">XI-IPA</a>
                  </li>
                  <li class="list-group-item">
                    <b>Tgl Lahir</b> <a class="float-right">24 Agustus 1991</a>
                  </li>
                  <li class="list-group-item">
                    <b>Alamat</b> <a class="float-right">Bluru Permai Blok FP no. 06, Sidoarjo</a>
                  </li>
                </ul>
                    ...
                    <form action="<?= base_url().'siswa/update';?>" method="post" class="form-horizontal">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" name="nama" class="form-control" value="<?= $s->nama; ?>" id="inputName" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group">
